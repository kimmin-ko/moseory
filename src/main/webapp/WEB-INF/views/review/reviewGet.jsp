	...
	<script type="text/javascript">
		$(document).ready(function() {
			...
			$("button[data-oper='list']").on("click", function(e) {
				...
				operForm.attr("action", "/review/reviewList");
				operForm.submit();
			});
		...
		<div class="row" style="margin-top: 70px; margin-bottom: 30px;">
			...
			<div class="col-md-10 col-md-offset-1 noticeLabel-row"
				...
				<table class="table table-bordered noticeView-table">
					...
					<tr>
						<td colspan="4" height ="300px" width="300px">${review.content };</td>
					</tr>
				</table>
			...
			<form id='operForm' action="/review/reviewModify" method="get">
				<input type='hidden' name='no'
					value='<c:out value = "${review.no }"/>'> <input
					type='hidden' name='reviewPageNum'
					value='<c:out value = "${reviewCri.reviewPageNum }"/>'> <input
					type='hidden' name='reviewAmount'
					value='<c:out value = "${reviewCri.reviewAmount }"/>'>
