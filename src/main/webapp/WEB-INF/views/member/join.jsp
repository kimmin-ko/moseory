...
<div class="container joinForm-container" style="margin-left:22%">
        ...
        <div class="col-md-10 col-md-offset-1" style="padding: 0;">
            <table class="table table-bordered">
                ...
                <tr>
                    ...
                    <td><input type="password" name="password" /> (영문 대소문자/숫자 4자~16자)</td>
                </tr>
                <tr>
                ...
                <tr>
                    ...
                    <td><input type="text" name="pwd_confirm_a" /></td>
                </tr>
                <tr>
                ...
                <tr>
                    <th>일반전화</th>
                    <td>
                        <select name="tell1"  style="width: 70px; height: 23px;">
                            <option>02</option>
                            <option>031</option>
                            <option>032</option>
                            <option>033</option>
                        ...
                        <input type="text" name="tell2" style="width: 100px;" /> - 
                        <input type="text" name="tell3" style="width: 100px;" />
                    </td>
                </tr>
                <tr>
                    <th>휴대전화</th>
                ...
                <tr>
                    <th>생년월일</th>
                    <td>
                        <input type="text" name="birth1" style="width: 80px;" />년
                        <input type="text" name="birth2" style="width: 50px;" />월
                        <input type="text" name="birth3" style="width: 50px;" />일&nbsp;
                        <input type="radio" name="calendar" value="solar_calendar">양력&nbsp;
                        <input type="radio" name="calendar" value="lunar_calendar">음력
                    </td>
                </tr>
            </table>
        </div>
    ...
    <div class="row" style="margin-bottom: 50px;">
        ...
        <div class="col-md-10 col-md-offset-1 use-agreement">
            ...
            <p>제22조(저작권의 귀속 및 이용제한)<br />① “몰“이 작성한 저작물에 대한 저작권 기타 지적재산권은 ”몰“에 귀속합니다.<br />② 이용자는 “몰”을 이용함으로써 얻은 정보 중 “몰”에게 지적재산권이 귀속된 정보를 “몰”의 사전 승낙 없이 복제, 송신, 출판, 배포, 방송 기타 방법에 의하여 영리목적으로 이용하거나 제3자에게 이용하게 하여서는 안됩니다.<br />③ “몰”은 약정에 따라 이용자에게 귀속된 저작권을 사용하는 경우 당해 이용자에게 통보하여야 합니다.</p><p>제23조(분쟁해결)<br />① “몰”은 이용자가 제기하는 정당한 의견이나 불만을 반영하고 그 피해를 보상처리하기 위하여 피해보상처리기구를 설치?운영합니다.<br />② “몰”은 이용자로부터 제출되는 불만사항 및 의견은 우선적으로 그 사항을 처리합니다. 다만, 신속한 처리가 곤란한 경우에는 이용자에게 그 사유와 처리일정을 즉시 통보해 드립니다.<br />③ “몰”과 이용자 간에 발생한 전자상거래 분쟁과 관련하여 이용자의 피해구제신청이 있는 경우에는 공정거래위원회 또는 시?도지사가 의뢰하는 분쟁조정기관의 조정에 따를 수 있습니다.</p>
            <p>제24조(재판권 및 준거법)<br />① “몰”과 이용자 간에 발생한 전자상거래 분쟁에 관한 소송은 제소 당시의 이용자의 주소에 의하고, 주소가 없는 경우에는 거소를 관할하는 지방법원의 전속관할로 합니다. 다만, 제소 당시 이용자의 주소 또는 거소가 분명하지 않거나 외국 거주자의 경우에는 민사소송법상의 관할법원에 제기합니다.<br />② “몰”과 이용자 간에 제기된 전자상거래 소송에는 한국법을 적용합니다. 부 칙(시행일) 이 약관은 년 월 일부터 시행합니다.</p>
        </div>
        <div class="col-md-10 col-md-offset-1" style="padding: 0;">
